    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException, ServletException {
        ...
        if (defaultFailureUrl == null) {
            ...
            if (forwardToDestination) {
                ...
                String authFailueMessage =  "Invalid username or paasword";
                if (exception instanceof BadCredentialsException) {
                    authFailueMessage = "Password is incorrect";
                } else if (exception instanceof UsernameNotFoundException) {
                    authFailueMessage = "Invalid user Name";
                }
                redirectStrategy.sendRedirect(request, response, defaultFailureUrl + "&j_username=" + request.getParameter("j_username") + "&authFailueMessage=" +authFailueMessage);
            }
        }
    }
