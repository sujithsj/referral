...
public class MMCommissionProcessorCopy {
    ...
    public MMCommissionProcessorCopy(EventTracking eventTracking, MarketingMaterial marketingMaterial, Affiliate affiliate, Campaign campaign) {
