...
public class EmailProcessingMDB implements MessageListener {
	...
	public TransactionTemplate getTransactionTemplate() {
		if(transactionTemplate == null){
			transactionTemplate = (TransactionTemplate)ServiceLocatorFactory.getService("transactionTemplate");
		}
	...
	public MailService getMailService() {
		if(mailService ==null){
			mailService = ServiceLocatorFactory.getService(MailService.class);
		}
		return mailService;
	}
	...
	public EmailTemplateService getEmailTemplateService() {
		if (emailTemplateService == null) {
			emailTemplateService = ServiceLocatorFactory.getService(EmailTemplateService.class);
		}
