...
public class AdminServiceImpl implements AdminService {
    ...
    public void addUser(User user, Role.RoleType[] roleRoleTypes) {
        ...
        UserSettings userSettings = getDefaultUserSettingsForRole(user.getUsername(), roleRoleTypes);
        ...
        userLoginConfirmationRequest.setProviderName(AppConstants.REFEROSCOPE);
    ...
    private UserSettings getDefaultUserSettingsForRole(String userName, Role.RoleType[] roleRoleTypes) {
        UserSettings userSettings = new UserSettings();
        userSettings.setUsername(userName);

        List<Role.RoleType> roles = Arrays.asList(roleRoleTypes);
        Set<Role.RoleType> roleSet = new HashSet<Role.RoleType>();
        roleSet.addAll(roles);

        if (roleSet.contains(Role.RoleType.affiliate)) {

            // userSettings.setCreatedDate(new Date());
            //userSettings.setCreatedBy(user.getUsername());

            userSettings.setSendEmailOnAddAffiliate(false);
            userSettings.setSendEmailOnGoalConversion(false);
            userSettings.setSendEmailOnJoinAffiliate(false);
            userSettings.setSendEmailOnPayout(false);
            userSettings.setSendEmailOnTerminateAffiliate(false);
        } else {
