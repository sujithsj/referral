 ...
 */
@Component
public class TopTenAffiliateByClickPieChart extends AbstractDataTableGenerator {
  ...
  public DataTable generateDataTable(Query query, HttpServletRequest request) throws DataSourceException {
    ...
    List<Object[]> topTenAffiliatesByClicks = getClickDao().getTopTenAffiiliatesByClicks(companyShortName, startDate, endDate);
    ...
    cd.add(new ColumnDescription("clicks", ValueType.NUMBER, "Clicks"));
    ...
    try {
      for (Object[] row : topTenAffiliatesByClicks) {
        ...
        tableRow.addCell(((BigInteger)row[0]).doubleValue());
