...
<s:layout-definition>
  ...
  <div id="sidebar">
    ...
    <ul>
      <li><a href="/pages/aff/affiliateDashboard.jsp"><i class="icon icon-home"></i> <span>Dashboard</span></a></li>
      <li>
      ...
      <li><a href="${pageContext.request.contextPath}/marketing/MarketingMaterialSearch.action"><i
          class="icon icon-file"></i> <span>Ads</span></a></li>
      <c:choose>
