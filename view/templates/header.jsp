      ...
      <div class="container">
        ...
        <div class="nav-collapse">
          <ul class="nav" style="float:right;font-size:18px;">
            ...
            <li><s:link beanclass="com.ds.action.affiliate.CompanyAffiliateSearchAction">Affiliate</s:link></li>
            <%--<li><a href="/pages/affiliate/companyAffiliates.jsp">Affiliate</a></li>--%>
