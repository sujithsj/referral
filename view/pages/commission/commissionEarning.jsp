                            ...
                            <div class="widget-content">
                                <s:form beanclass="com.ds.action.commission.CommissionEarningSearchAction"
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a class="btn ceType" href="#"
                                           type="<%=EnumCommissionEarningStatus.PENDING_APPROVAL.getId()%>">Pending Approval</a>
                                        <a class="btn ceType" href="#"
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-content nopadding">
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <c:forEach items="${commissionSearchAction.commissionEarnings}" var="commissionEarning">
                                        <tr>
