                    ...
                    <div class="span10">
                        <div class="widget-box">
                            ...
                            <div class="widget-content">
                                <s:form beanclass="com.ds.action.campaign.CampaignSearchAction" id="commissionSearchForm"
                                        class="form-inline">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a class="btn cpType" href="#"
                                           type="<%=EnumCampaignType.SALE.getId()%>">Sale</a>
                                        <a class="btn cpType" href="#"
                                           type="<%=EnumCampaignType.EMAIL_OPT_IN.getId()%>">Email Opt In</a>
                                        <a class="btn cpType" href="#"
                                           type="<%=EnumCampaignType.USER_SIGN_UP.getId()%>">User Sign Up</a>
                                        <a class="btn cpType" href="#"
                                           type="<%=EnumCampaignType.AFFILIATE_SIGN_UP.getId()%>">Affiliate
                                            Sign
                                            Up</a>
                                    </div>
                                    <%--  </div>--%>
                            ...
                            <div class="row-fluid">
                                <div class="span3">
                                    <s:layout-render name="/layouts/paginationResultCount.jsp"
                                                     paginatedBean="${campaignSearchAction}"/>
                                </div>
                                <div class="span9">
