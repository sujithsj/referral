...
<s:layout-render name="/templates/general.jsp">
	...
	<s:layout-component name="content">
		...
		<s:useActionBean beanclass="com.ds.action.aff.marketing.AffiliateClickTrafficAction" var="affiliateClickTrafficAction"/>
		<div id="content">
			<div id="breadcrumb">
			...
			<s:form beanclass="com.ds.action.aff.marketing.AffiliateClickTrafficAction" class="form-horizontal" id="mmCrudForm">
								...
								<div class="collapse in " id="collapseCampaigns" style="border-bottom:1px solid #CDCDCD;">
									<div class="widget-content" style="border-bottom:none;">
										<s:select name="companyShortName" style="width:400px;">
											...
											<c:forEach items="${affiliateClickTrafficAction.allEligibleCompanies}" var="company">
